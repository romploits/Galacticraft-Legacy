...
public interface IGameScreen
{
    ...
    /**
     * Set up the frame edge size for this screen. This part must not be drawn
    ...
    /**
     * Draw a screen in the XY plane with z == 0. Must fit in the coordinate
     * range (0, 0, 0) - (scaleX, scaleY, 0)
     * 
     ...
     * @param screen The screen driver (DrawGameScreen) for this particular
     *        screen
     * 
     *        NOTE 1: It is not necessary to enclose your code with glPushMatrix
     *        and glPopMatrix, as this will be done by the calling method. You
     *        can also change the lighting in your render as the calling method
     *        will finish by calling RenderHelper.enableStandardItemLighting().
     * 
