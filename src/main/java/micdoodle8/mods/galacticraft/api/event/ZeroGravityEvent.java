...
public abstract class ZeroGravityEvent extends LivingEvent
{
    ...
    /**
     * Cancel this to return false on all freefall tests "Freefall" = feet not
     * on a block in a Zero G Dimension
     */
    @Cancelable
    ...
    /**
     * Cancel this to block special Zero G dimension motion (moving on walls,
     * and jumping and landing on blocks)
     */
    @Cancelable
    ...
    /**
     * Cancel this to block the sneak override on Zero G dimensions when
     * descending (no sneak) or landing (sneak during impact)
     * 
     * (This sneaking will mostly be cancelled anyhow if the Motion event is
     * cancelled)
     */
    @Cancelable
