...
public class BiomeAdaptive extends BiomeGenBaseGC
{
    ...
    /**
     * Be sure to call this from your BiomeProvider in: <br>-- getBiome(BlockPos
     * pos, Biome defaultBiome) <br>-- getBiomesForGeneration(Biome[] biomes,
     * int x, int z, int length, int width) <br>-- getBiomes(@Nullable Biome[]
     * oldBiomeList, int x, int z, int width, int depth) <br>--
     * getBiomes(@Nullable Biome[] listToReuse, int x, int z, int width, int
     * length, boolean cacheFlag) <br>also from your WorldProvider in: <br>--
     * getBiomeProviderClass() <p> See BiomeProviderVenus for an example.
     */
    ...
    // ===========================================================================
    // ===============Pass through all Biome methods to the true
    // biome============
    // ===========================================================================
