...
public class OxygenHooks
{
     ...
     * 
     * @return False if fire burns normally True if fire cannot burn in this
     *         world
     * 
     */
     ...
     * blocks on all sides (for example torches, ladders, signs, wires, chests
     * etc etc) then it may have to look quite far to find whether it is in
     * oxygen or not - it will check up to 5 blocks in each direction. This can
     * impose a performance load in the unlikely event there are permeable
     * blocks in all directions. It is therefore advisable not to call this
     * every tick: 1 tick in 5 should be plenty.
     * 
    ...
    /**
     * Special version of the oxygen AABB check for living entities. This is
     * based on checking the oxygen contact of a small box centred at the
     * entity's eye height. The small box has sides equal to half the width of
     * the entity. This is a good approximation to head size and position for
     * most types of mobs.
     * 
     * @param entity
     ...
     * with torch blocks and other oxygen-requiring blocks which can access
     * oxygen on any side.
     * 
     ...
     * 
     * @param world
     * @param block The block type of this torch being checked - currently
     *        unused
     * @param pos The x, y, z position of the torch
     * @return True if there is a (sealed) oxygen block accessible, otherwise
     *         false.
     */
    ...
    /**
     * Test whether a location is inside an Oxygen Bubble from an Oxygen
     * Distributor
     * 
