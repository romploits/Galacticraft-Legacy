...
public class EventHandlerClient
{
    ...
    @SubscribeEvent(priority = EventPriority.LOWEST) // Lowest priority to do
                                                     // the PushMatrix last,
                                                     // just before vanilla
                                                     // RenderPlayer - this also
                                                     // means if it gets
                                                     // cancelled first by
                                                     // another mod, this will
                                                     // never be called
    ...
    @SubscribeEvent(priority = EventPriority.HIGHEST) // Highest priority to do
                                                      // the PushMatrix first,
                                                      // just after vanilla
                                                      // RenderPlayer
