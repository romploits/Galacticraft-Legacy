...
public class OverlayOxygenWarning extends Overlay
{
    ...
    public static void renderOxygenWarningOverlay(Minecraft mc, long ticks)
    {
        ...
        mc.fontRenderer.drawString(GCCoreUtil.translate("gui.oxygen.warning"), width / 4 - mc.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.oxygen.warning")) / 2, height / 8,
            ColorUtil.to32BitColor(alpha, 255, 0, 0));
