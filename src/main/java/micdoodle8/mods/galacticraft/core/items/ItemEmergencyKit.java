...
public class ItemEmergencyKit extends ItemDesc implements ISortableItem, GCRarity
{
    ...
    public static Object[] getRecipe()
    {
        ...
        {"EAB", "CID", "FGH", 'A', null, 'B', null, 'C', null, 'D', null, 'E', null, 'F', null, 'G', null, 'H', null, 'I', null};
        for (int i = 0; i < SIZE; i++)
        {
