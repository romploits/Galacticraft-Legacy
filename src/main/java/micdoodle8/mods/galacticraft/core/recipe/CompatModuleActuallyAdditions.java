...
public class CompatModuleActuallyAdditions
{
    ...
    public static void addRecipes()
    {
        ...
        // Silicon ore :- gives 5 silicon (normally 1-5 depending on fortune
        // enchantment)
        ...
        // Cheese ore :- gives 2 cheese curd (normally 1, fortune enchantment
        // gives chance of 2)
        ...
        {
            // Desh ore :- gives 2 raw desh (normally 1, fortune enchantment
            // gives chance of 2)
