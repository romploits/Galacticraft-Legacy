...
public class TileEntityElectricFurnace extends TileBaseElectricBlockWithInventory implements ISidedInventory, IMachineSides
{
    ...
    @NetworkedField(targetSide = Side.CLIENT) public int processTimeRequired = PROCESS_TIME_REQUIRED;
    ...
    public void update()
    {
        if (!this.initialised)
        {
            ...
            if (b == GCBlocks.machineBase)
            {
                this.world.setBlockState(this.getPos(),
                    GCBlocks.machineTiered.getDefaultState()/*
                                                             * ,s 4
                                                             */, 2);
            } else if (metadata >= 8)
            {
        ...
        if (!this.world.isRemote)
        {
            if (this.canProcess())
            {
                ...
                {
                    // 100% extra speed boost for Tier 2 machine if powered by
                    // Tier 2 power
                    if (this.tierGC >= 2)
                    {
                ...
                {
                    // Apply a "cooling down" process if the electric furnace
                    // runs out of energy while smelting
        ...
        {
            // Smoother client side animation before the networked fields get
            // updated
    ...
    public boolean canProcess()
    {
        ...
        if (result.isEmpty())
        {
            ...
            if (burnable >= 200 && burnable < 400)
                result = new ItemStack(MarsItems.carbonFragments); // this
                                                                   // includes
                                                                   // most
                                                                   // wooden
                                                                   // tools,
