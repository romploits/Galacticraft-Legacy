...
public class TileEntityEmergencyBox extends TileEntity implements ITickable, IPacketReceiver
{
    ...
    {
        GalacticraftCore.packetPipeline.sendToAllAround(new PacketDynamic(this),
            new NetworkRegistry.TargetPoint(GCCoreUtil.getDimensionID(this.world), getPos().getX(), getPos().getY(), getPos().getZ(), 128));
    }
