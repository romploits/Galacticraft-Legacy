...
public class CompatModuleIC2Asteroids
{
    ...
    public static void addIC2Recipes(ItemStack titaniumIngot, ItemStack titaniumDust)
    {
        ...
        RecipeUtil.addRecipe(new ItemStack(AsteroidsItems.basicItem, 1, 9), new Object[]
        {"XXX", "XXX", "XXX", 'X', new ItemStack(GCItems.ic2compat, 1, 7)});
        ...
        // Asteroids and Venus versions of aluminium ore (because IC2 oredicting
        // or .ini will not pick up aluminium ores)
