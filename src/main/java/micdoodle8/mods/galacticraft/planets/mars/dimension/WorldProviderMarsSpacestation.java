...
public class WorldProviderMarsSpacestation extends WorldProviderSpaceStation implements IOrbitDimension, IZeroGDimension, ISolarLevel, IExitHeight
{
    ...
    {
        return GCPlanetDimensions.MARS_SPACESTATION;
    }
    ...
    {
        return MarsModule.marsSpaceStation;
    }
