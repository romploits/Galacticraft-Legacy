...
public class MarsUtil
{
    ...
    public static void openCargoRocketInventory(EntityPlayerMP player, EntityCargoRocket rocket)
    {
        ...
        int windowId = player.currentWindowId;
        GalacticraftCore.packetPipeline.sendTo(new PacketSimpleMars(EnumSimplePacketMars.C_OPEN_CUSTOM_GUI, GCCoreUtil.getDimensionID(player.world), new Object[]
        {windowId, 1, rocket.getEntityId()}), player);
    ...
    public static void openAdvancedLaunchController(EntityPlayerMP player, TileEntityLaunchController launchController)
    {
        ...
        player.closeContainer();
        int windowId = player.currentWindowId;
        GalacticraftCore.packetPipeline.sendTo(new PacketSimpleMars(EnumSimplePacketMars.C_OPEN_CUSTOM_GUI_TILE, GCCoreUtil.getDimensionID(player.world), new Object[]
        {windowId, 0, launchController.getPos()}), player);
