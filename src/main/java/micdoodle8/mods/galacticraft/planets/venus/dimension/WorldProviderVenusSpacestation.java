...
public class WorldProviderVenusSpacestation extends WorldProviderSpaceStation implements IOrbitDimension, IZeroGDimension, ISolarLevel, IExitHeight
{
    ...
    {
        return GCPlanetDimensions.VENUS_SPACESTATION;
    }
    ...
    {
        return VenusModule.venusSpaceStation;
    }
